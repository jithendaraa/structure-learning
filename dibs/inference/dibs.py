...
class DiBS:
    ...
    def eltwise_log_joint_prob(self, gs, single_theta, rng, data=None):
        ...
        return vmap(self.target_log_joint_prob, (0, None, None), 0)(gs, data, single_theta, rng)
    ...
    def eltwise_grad_z_likelihood(self,  zs, thetas, baselines, t, subkeys, data=None):
        ...
        # vmap
        return vmap(grad_z_likelihood, (0, 0, 0, None, 0), (0, 0))(zs, thetas, baselines, t, subkeys, data)
    ...
    def grad_z_likelihood_score_function(self, single_z, single_theta, single_sf_baseline, t, subk, data=None):
        ...
        # [n_grad_mc_samples, ] 
        subk, subk_ = random.split(subk)
        logprobs_numerator = self.eltwise_log_joint_prob(g_samples, data, single_theta, subk_)
