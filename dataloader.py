...
def parse_datasets(opt, device):
    ...
    if opt.dataset == 'clevr':
        ...
        train_dataloader = ER(num_nodes = opt.num_nodes, exp_edges = opt.exp_edges, noise_type = opt.noise_type, noise_sigma = opt.noise_sigma, num_samples = opt.num_samples, mu_prior = opt.theta_mu, sigma_prior = opt.theta_sigma, seed = opt.data_seed, project=opt.proj, proj_dims=opt.proj_dims)
