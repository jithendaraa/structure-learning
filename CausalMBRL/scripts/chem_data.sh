...
max_steps=$4
movement=$5
# python data_gen/env.py --env-id ColorChangingRL-$num_obj-$num_colors-$movement-$max_steps-v0 --fname data/ColorChangingRL_$num_obj-$num_colors-$max_steps-$movement-train-$graph.h5  --num-episodes 10 --episode-length 100 --seed 1 --save_graph --save_graph_location data/ColorChangingRL_$num_obj-$num_colors-$max_steps-$movement-train-graph-$graph --graph $graph
...
python data_gen/env.py --env-id LinGaussColorCubesRL-$num_obj-$num_colors-$movement-$max_steps-v0 --fname data/ColorChangingRL_$num_obj-$num_colors-$max_steps-$movement-train-$graph.h5  --num-episodes 10 --episode-length 100 --seed 1 --save_graph --save_graph_location data/ColorChangingRL_$num_obj-$num_colors-$max_steps-$movement-train-graph-$graph --graph $graph
