...
class ColorChangingRL(gym.Env):
    ...
    def __init__(self, width=5, height=5, render_type='cubes',
        ...
        self.colors, _ = utils.get_colors_and_weights(cmap = 'Blues', num_colors = self.num_colors, observed=True)#[mpl.colors.to_rgba(colors[i]) for i in range(self.num_colors)]
    ...
    def generate_target(self, num_steps = 10):
        ...
        for i in range(num_steps):
            ...
            # print(f"intervention id: {intervention_id}, value: {to_color}")
            # print(f"Before: {self.object_to_color_target}")
            ...
            # print(f"After: {self.object_to_color_target}")
    ...
    def step(self, action: int):
        ...
        # print(f"Intervention: node {obj_id}, color {color_id}")
