...
class Trainer(BaseTrainer):
    ...
    def __init__(self, model, loss, metrics, optimizer, resume, config,
                 ...
                 train_logger=None, gt_bin_W=None):
    ...
    def _train_epoch(self, epoch, config):
        """
        ...
        if config['dataset'] == "chemdata":
            log['pred_images'] = output['mu'].reshape(output['mu'].shape[0], 1, 50, 50)   
            log['gt_image'] = data[0].reshape(50, 50)
